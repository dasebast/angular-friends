...
app.controller('friendsController', function ($scope) {
	...
	$scope.items = [{raw: "name", pretty: "Name"}, {raw: "friend_count", pretty: "# of Friends"}, {raw: "current_location.city", pretty: "City"}, {raw: "current_location.state", pretty: "State"}, {raw: "current_location.country", pretty: "Country"}];
